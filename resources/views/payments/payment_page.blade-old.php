...
<form action="{{ route('payments.process') }}" method="POST" style="background:#ffffff; padding: 20px;">
    @csrf
    ...
    <select id="who" name="who" required style="background:#ffffff; color: black; border: 1px solid #ccc; padding: 5px; width: 100%;">
    </select><br><br>

    <label for="amount" style="color: black;">Amount:</label><br>
    <input type="text" id="amount" name="amount" placeholder="0" readonly style="background:#ffffff; color: black; border: 1px solid #ccc; padding: 5px; width: 100%;"><br><br>
